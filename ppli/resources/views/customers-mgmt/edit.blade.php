            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('customer-management.update', ['id' => $customer->id]) }}">
                            ...
                            <div class="form-group{{ $errors->has('comp_title') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="comp_title" type="text" class="form-control" name="comp_title" value="{{ $customer->comp_title }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('comp_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="comp_name" type="text" class="form-control" name="comp_name" value="{{ $customer->comp_name }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="address" type="address" class="form-control" name="address" value="{{ $customer->address }}" required>
                            ...
                            <div class="form-group{{ $errors->has('npwp') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="npwp" type="text" class="form-control" name="npwp" value="{{ $customer->npwp }}" required>
                            ...
                            <div class="form-group{{ $errors->has('sap_num') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="sap_num" type="text" class="form-control" name="sap_num" value="{{$customer->sap_num }}" required>
