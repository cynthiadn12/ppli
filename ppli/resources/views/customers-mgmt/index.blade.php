    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                <div class="row">
                    <div class="col-sm-8">
                        <a class="btn btn-success" href="{{ route('customer-management.create') }}"><i class="fa fa-plus-circle">New Customer</i></a>
                    </div>
                </div>
            </div>
            <!-- /.box-header -->
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <form class="row" method="POST" action="{{ route('customer-management.destroy', ['id' => $customer->id]) }}" onsubmit = "return confirm('Are you sure?')">
                                                ...
                                                <a href="{{ route('customer-management.edit', ['id' => $customer->id]) }}" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
